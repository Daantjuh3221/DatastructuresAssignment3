...
public class HighScorePlayerFinder implements HighScoreList {
    ...
    @Override
    public void showCollisions(int arraySize){
        System.out.println("Array size is " + arraySize);
        System.out.println("Linear probing method has: " + firstNameFinder.getCollisions() + " collisions");
        System.out.println("Quadratic probing method has: " + lastNameFinder.getCollisions() + " collisions");
        System.out.println("Double hashing method has: " + fullNameFinder.getCollisions() + " collisions");
        System.out.println("");
    }
